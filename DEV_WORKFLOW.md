...
```
Phase N (期間は柔軟)
  ├── Milestone vX.Y   (短期)  ← マイナー機能・バグ修正をリリース
  ├── Milestone vX.Y+1 (中期)  ← 追加機能をリリース
  └── Milestone vX+1.0 (長期)  ← メジャー機能活性化してリリース
```

- Milestone = 具体的なリリースポイント（原則1ヶ月以内）
